...
import com.digitaleo.sampledigitaleosdk.contact.ContactFragment;
import com.digitaleo.sampledigitaleosdk.message.MessageFragment;
...
public class HomeActivity extends ActionBarActivity
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                mTitle = getString(R.string.menu_contact);
                break;
            case 2:
                mTitle = getString(R.string.menu_message);
                break;
            case 3:
